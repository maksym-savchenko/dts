  ...
  <div class="container">
    <div class="header-wrapper">
      <a class="brand transition-none text-white" href="<?php echo e(home_url('/')); ?>">
        ...
        <?php if($header_middle || $header_top || $header_bootom): ?>
          <div class="brand-text [&_p]:opacity-100 [&_p]:uppercase [&_p]:font-black">
            <?php if($header_top): ?>
              <p class="tracking-[1px] leading-[16px]"><?php echo e($header_top); ?></p>
            <?php endif; ?>
              <?php if($header_middle): ?>
                <p class="text-[25px] leading-[28px]"><?php echo e($header_middle); ?></p>
              <?php endif; ?>
              <?php if($header_bottom): ?>
                <p class="tracking-[1px] text-[7px] leading-[20px]"><?php echo e($header_bottom); ?></p>
              <?php endif; ?>
          </div>
        <?php else: ?>
          <?php echo $siteName; ?>
