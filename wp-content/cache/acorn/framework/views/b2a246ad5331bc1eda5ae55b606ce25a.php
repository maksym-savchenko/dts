...
<?php if($form): ?>
  <div class="popup-wrapper fixed top-0 left-0 right-0 bottom-0 z-[99] sm:flex py-20 sm:justify-center sm:items-center opacity-0 touch-none pointer-events-none transition-opacity duration-500 overflow-y-scroll no-scrollbar" data-popup="popup-form">
    <div class="popup-overlay fixed top-0 left-0 right-0 bottom-0 bg-black opacity-40 z-[99]"></div>
    <div class="container">
      <div class="popup-form z-[99] relative my-auto">
...
<?php endif; ?>
<?php /**PATH /Users/maksym/Local Sites/donbas/app/public/wp-content/themes/bspd/resources/views/partials/form-popup.blade.php ENDPATH**/ ?>