...
<?php if($form): ?>
  <div class="popup-wrapper fixed top-0 left-0 right-0 bottom-0 z-[99] py-36 flex justify-center items-center">
    <div class="popup-overlay fixed top-0 left-0 right-0 bottom-0 bg-black opacity-40 z-[99]"></div>
      <div class="popup-form z-[99] relative overflow-scroll no-scrollbar w-full h-full flex justify-center items-center py-100">
        <div class="container">
